...
public class AnalysisResult {
    ...
    public boolean isWhiteLegal() { return whiteLegal; }

    /** @return {@code true} if the ML model classified black's play as fair */
    public boolean isBlackLegal() { return blackLegal; }

    /** @return {@code true} if both players are classified as fair play */
    public boolean isLegal() { return whiteLegal && blackLegal; }
